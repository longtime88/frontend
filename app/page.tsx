    ...
    <section className="relative overflow-hidden pb-20">
      <div className="mx-auto mt-6 grid max-w-7xl gap-8 px-4 md:mt-10 md:grid-cols-[1.2fr,0.8fr] md:px-6">
        <div className="glass-panel reveal-rise relative overflow-hidden rounded-3xl p-7 md:p-10">
          <div className="absolute -right-24 -top-28 h-72 w-72 rounded-full bg-[#cfe0ff] blur-3xl" />
          <p className="relative z-10 mb-4 w-fit rounded-full bg-[#e6efff] px-4 py-1 text-xs font-bold tracking-[0.14em] text-[color:var(--brand-deep)]">
      ...
      <div className="mx-auto mt-12 max-w-7xl px-4 md:px-6">
        <div className="reveal-rise mb-7 flex items-end justify-between">
          <div>
            ...
            <h2 className="brand-title text-3xl font-bold text-[color:var(--ink)] md:text-4xl">Leistungen & Produkte</h2>
          </div>
        </div>
        <Category />
      </div>
      ...
      <div id="produkte" className="mx-auto mt-14 max-w-7xl px-4 md:px-6">
        <div className="reveal-rise mb-7 flex items-end justify-between">
          <div>
            ...
            <h2 className="brand-title text-3xl font-bold text-[color:var(--ink)] md:text-4xl">Digitale Bestseller</h2>
          </div>
        </div>
        <Products />
      </div>
      ...
      <div className="mx-auto mt-12 max-w-7xl px-4 md:px-6">
        <div className="reveal-rise rounded-3xl bg-[#0f172a] px-6 py-10 text-white md:px-10">
          <h2 className="brand-title text-3xl font-bold md:text-4xl">Bereit für Kundenprojekte & Verkäufe</h2>
          <div className="mt-5 flex flex-wrap gap-6 text-sm font-semibold tracking-wide text-[#cbd5e1]">
